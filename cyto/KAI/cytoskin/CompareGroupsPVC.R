##This script finds differentially expressed genes between general groups(Skin samples only!) without taking to account phenotype and specific subgroups.
##Specific group comparisons are in phenoLimma.R
##Metadata is created in the file CreateMetadata.R
## CT-calculators are processed and new dataset is assembled in CT-files.R
...
#rows=rownames(p[2:44,])
#cols=as.character(p[1,])
#p <- apply(p[2:44,],2,as.numeric)
##standardisation
...
data.st=scale(data)
pheatmap(data.st, cluster_rows = F, cluster_cols = F, scale = "row", main="All data after standardization")
summary(data.st)
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/PHvsPTup.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/PHvsPTdown.txt",sep="\t",row.names=F,quote=FALSE)
PhvsPt=Gene
...
colnames(data_heatm)=cols
data_heatm=data_heatm[ , ! apply( data_heatm , 2 , function(x) all(is.na(x)) ) ]#removes columns with complete NAs
pheatmap(data_heatm, cluster_rows = T, cluster_cols = F, scale = "row", main="Psoriasis.Differentially expressed in PTvsC")
tt[,1]=tt[,1]*(-1)
Gene=rownames(tt)
tt=cbind(Gene,tt)
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/PTvsCup.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/PTvsCdown.txt",sep="\t",row.names=F,quote=FALSE)
PTvsC=Gene
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/VHvsCup.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/VHvsCdown.txt",sep="\t",row.names=F,quote=FALSE)
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/VTvsCup.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/VTvsCdown.txt",sep="\t",row.names=F,quote=FALSE)
VTvsC=Gene
############ PH&VH vs C ######
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/PH_VH_vs_C_up.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/PH_VH_vs_C_down.txt",sep="\t",row.names=F,quote=FALSE)
PH_VH_vs_C=Gene
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/PT_VT_vs_C_up.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/PT_VT_vs_C_down.txt",sep="\t",row.names=F,quote=FALSE)
...
down=tt[tt[,2]<0,]
up=tt[tt[,2]>0,] 
write.table(up,file="~/Documents/KAI/cytoskin/after_filt/31102014/PHvsVHup.txt",sep="\t",row.names=F,quote=FALSE)
write.table(down,file="~/Documents/KAI/cytoskin/after_filt/31102014/PHvsVHdown.txt",sep="\t",row.names=F,quote=FALSE)
PHvsVH=Gene

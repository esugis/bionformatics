...
save(DataControllsBlood_QR, file="~/Documents/KAI/cytoskin/BLOOD/datacontrol_QR.RData")
write.table(file="~/Documents/KAI/cytoskin/BLOOD/datacontrol_QR.txt",DataControllsBlood_QR, sep="\t", quote=F )      

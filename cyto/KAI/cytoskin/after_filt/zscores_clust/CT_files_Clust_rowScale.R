...
write.table(file="~/Documents/KAI/cytoskin/after_filt/17112014/data.control_newfilt.txt",DataControllsSkin, sep="\t", quote=F )      
...
write.table(file="~/Documents/KAI/cytoskin/after_filt/17112014/data.psoriasis_newfilt.txt",DataPsoriasisSkin, sep="\t", quote=F )      
...
write.table(file="~/Documents/KAI/cytoskin/after_filt/17112014/data.vitiliigo_newfilt.txt",DataVitiliigoSkin, sep="\t", quote=F )      
...
main="Filtered log-transformed data after imputation. KNN, k=4", filename="~/Documents/KAI/cytoskin/after_filt/17112014/noscale/filtered_imputed_knn4.png")
...
gs_exp = add_expression.gosummaries(gs, exp = data_clust,
                                    annotation = annot)
setwd("~/Documents/KAI/cytoskin/after_filt/figure_clustering_log2_data/")
plot(gs_exp, fontsize = 8, classes = "Groups", filename = "Gosummaries_kmeans5_knn4_log.pdf")
##end go summaries
...
save(data.log,Groups,Samples,file="~/Documents/KAI/cytoskin/after_filt/17112014/noscale/pca.RData")

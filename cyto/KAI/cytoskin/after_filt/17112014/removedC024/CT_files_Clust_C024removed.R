...
data.pca=data.log
library(stringr)
colnames(data.pca)=str_replace(colnames(data.pca),"PH","PS")#sick
colnames(data.pca)=str_replace(colnames(data.pca),"PT","PH")#healthy
colnames(data.pca)=str_replace(colnames(data.pca),"VH","VS")#sick
colnames(data.pca)=str_replace(colnames(data.pca),"VT","VH")#healthy


#data.pca=scale(data.log)#col scaling
#data.pca=scale_rows(data.log)

pheatmap(data.pca, cluster_rows = F, cluster_cols = F,scale = "none", main="All data scaled, contains NA",
         filename="~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/data_log_NAs.png")
#pheatmap(data.pca, cluster_rows = T, cluster_cols = F,scale = "row",
# main="All data scaled, contains NA")

write.table(data.pca,file="~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/data_all_log2_with_NA.txt",sep="\t",row.names=T,quote=FALSE)
...
data.pca=t(data.pca.new)
pheatmap(data.pca, cluster_rows = F, cluster_cols = F,scale = "none",main="Gene expression log-transformed data. Rows and columns containing >50% missing values are removed",
         filename="~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/data_log_filt_NAs.png")

dim(data.pca)#35 117
data_log2_filt=data.pca
save(data_log2_filt,file = "~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/data_log2_filt.RData")
...
main="Filtered log-transformed data after imputation. KNN, k=4", filename="~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/filtered_imputed_knn4.png")
...
Groups=str_replace(Groups,"PS.*","Psoriasis sick")
Groups=str_replace(Groups,"PH.*","Psoriasis healthy")
Groups=str_replace(Groups,"VS.*","Vitiligo sick")
Groups=str_replace(Groups,"VH.*","Vitiligo healthy")
...
gs_exp = add_expression.gosummaries(gs, exp = data_clust,
                                    annotation = annot)
setwd("~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/")
plot(gs_exp, fontsize = 8, classes = "Groups", filename = "Gosummaries_data_log2_knn4_hc_11012014.pdf")

save(ct,hc.data,data_hc, file = "~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/hc.RData")
...
write.table(file="~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/data_log2_kmeans6_knn4.txt",data_km, sep="\t", quote=F )      
save(km, file = "~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/km6.RData")
...
plot(gs_exp, fontsize = 8, classes = "Groups", filename = "~/Documents/KAI/cytoskin/after_filt/17112014/removedC024/Gosummaries_kmean6_knn4_log_11012014.pdf")
##end go summaries

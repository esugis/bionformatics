...
#Scrit compiles expression matrix for PSO blood data. Expression is normalised against Bact gene.
...
length(rowsC)
#[1] 105
DataPsoriasisBloodBact=rowsC
DataPsoriasisBloodBact=as.data.frame(DataPsoriasisBloodBact)
colnames(DataPsoriasisBloodBact)=c("SAMPLE")
library(functional)
...
for(i in 1:length(psoriasis1)){  
 ...
 # CTdata1[,2:17]=apply(CTdata1[,2:17],2, as.numeric)
  ...
  #print("new geneEXP")
  #print(geneExpr)
  DataPsoriasisBloodBact=merge(DataPsoriasisBloodBact,geneExpr, by.x="SAMPLE", by.y="SAMPLE", all.x=T )
  #print(DataControllsBlood)
}
##using MAD
#DataPsoriasisBlood=DataPsoriasisBlood
#save(DataPsoriasisBlood, file="~/Documents/KAI/cytoskin/BLOOD_BACT/datapsoriasis.RData")
#write.table(file="~/Documents/KAI/cytoskin/BLOOD_BACT/datapsoriasis.txt",DataPsoriasisBlood, sep="\t", quote=F )      

##alternatively filter on quartiles
DataPsoriasisBloodBact_QR=DataPsoriasisBloodBact
save(DataPsoriasisBloodBact_QR, file="~/Documents/KAI/cytoskin/BLOOD_BACT/DataPsoriasisBloodBact_QR.RData")
write.table(file="~/Documents/KAI/cytoskin/BLOOD_BACT/DataPsoriasisBloodBact_QR.txt",DataPsoriasisBloodBact_QR, sep="\t", quote=F )      

...
CTRefMean=CTRefMean[c(1:48,52:75),c(1,2)]
dim(CTRefMean)
colnames(CTRefMean)[2]="CTRef"
colnames(CTRefMean)[1]="SAMPLE"
#CTRefMean$Order=gsub("_.*","",CTRefMean$)
save(CTRefMean, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefMean.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefMean.txt",CTRefMean, sep="\t", quote=F )      
CTRefStd=CTRefStd[c(1:48,52:75),c(1,2)]
dim(CTRefStd)
colnames(CTRefStd)[2]="STDRef"
colnames(CTRefStd)[1]="SAMPLE"
save(CTRefStd, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefStd.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTReStd.txt",CTRefStd, sep="\t", quote=F )      
CTRefCal=CTRefCal[c(1:48,52:75),c(1:13,15:16)]
dim(CTRefCal)
save(CTRefCal, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefCal.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefCal.txt",CTRefCal, sep="\t", quote=F )      

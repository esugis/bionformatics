...
DataPsoriasisBlood_nd=DataPsoriasisBlood
save(DataPsoriasisBlood_nd, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/datapsoriasis_nd.RData")
write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/datapsoriasis_nd.txt",DataPsoriasisBlood_nd, sep="\t", quote=F )      

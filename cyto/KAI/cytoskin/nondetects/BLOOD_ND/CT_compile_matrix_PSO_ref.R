...
CTRefMean_PSO=CTRefMean[,c(1,2)]
dim(CTRefMean_PSO)
colnames(CTRefMean_PSO)[2]="CTRef"
colnames(CTRefMean_PSO)[1]="SAMPLE"
#CTRefMean$Order=gsub("_.*","",CTRefMean$)
save(CTRefMean_PSO, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefMean_PSO.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefMean_PSO.txt",CTRefMean_PSO, sep="\t", quote=F )      
CTRefStd_PSO=CTRefStd[,c(1,2)]
dim(CTRefStd_PSO)
colnames(CTRefStd_PSO)[2]="STDRef"
colnames(CTRefStd_PSO)[1]="SAMPLE"
save(CTRefStd_PSO, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefStd_PSO.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTReStd_PSO.txt",CTRefStd_PSO, sep="\t", quote=F )      
CTRefCal_PSO=CTRefCal[,c(1:13,15:16)]
dim(CTRefCal_PSO)
save(CTRefCal_PSO, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefCal_PSO.RData")
#write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND/CTRefCal_PSO.txt",CTRefCal_PSO, sep="\t", quote=F )      

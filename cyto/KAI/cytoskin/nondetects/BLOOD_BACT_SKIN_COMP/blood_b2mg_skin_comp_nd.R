...
chart.Correlation((t(IL17A)),method="spearman", main="Spearman correlation between expression profiles of IL17A in PL, SEB, PMA, 72h ")#check this one
...
chart.Correlation(t(IL17F[1:3,]),method="spearman", main="Spearman correlation between expression profiles of IL17F in PL, SEB(B2mg), PMA(B2mg)")#check this one
...
chart.Correlation(t(IL22),method="spearman", main="Spearman correlation between expression profiles of IL22 in PL, SEB(B2mg), PMA(B2mg), 72h(B2mg)")#check this one
...
chart.Correlation(t(IL10),method="spearman", main="Spearman correlation between expression profiles of IL10 in PL, SEB(B2mg), PMA(B2mg), 72h(B2mg)")#check this one

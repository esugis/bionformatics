...
DataControllsBlood_nd_bact=DataControllsBlood[c(1:144,154:225),]#remove C024 from the data.
dim(DataControllsBlood_nd_bact)#216 15
save(DataControllsBlood_nd_bact, file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND_bact/datacontrol_nd_bact.RData")
write.table(file="~/Documents/KAI/cytoskin/nondetects/BLOOD_ND_bact/datacontrol_nd_bact.txt",DataControllsBlood_nd_bact, sep="\t", quote=F )      

...
summary(data.all)
save(data.all, file = "~/Documents/KAI/cytoskin/after_filt/21112014/data.all.RData")
...
dim(data.pca)#35 118
data_all_filt=data.pca
#save(data_all_filt, file = "~/Documents/KAI/cytoskin/after_filt/31102014/data_all_filt.RData")
save(data_all_filt, file = "~/Documents/KAI/cytoskin/after_filt/21112014/data_all_filt_nontransformed.RData")
